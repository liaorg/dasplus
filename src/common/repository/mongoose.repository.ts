...
type ObjectIdType = Types.ObjectId | string | number;

/**
 * 公共服务 数据库操作服务
 */
export class MongooseRepository<TM = any, TD = HydratedDocument<TM>> {
    private logger = new Logger(MongooseRepository.name);
    private model: Model<TM>;
